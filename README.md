...
```
$ docker image tag app1 aloneload/app1
$ docker push aloneload/app1
$ docker image tag app2 aloneload/app2
$ docker push aloneload/app2
$ docker image tag getway aloneload/getway
$ docker push aloneload/getway
$ docker image tag uaa aloneload/uaa
$ docker push aloneload/uaa
```
